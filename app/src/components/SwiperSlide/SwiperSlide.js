  ...
  return (
    <div id="swiper_slide_main">
      {props.data
        ...
        .map((item, idx) => (
          <h1 key={`uqyruwqyuw${item.id}`}>{item.genre}</h1>
        ))}
      <Swiper
        slidesPerView={5}
        spaceBetween={30}
      ...
      {props.data
        ...
        .map((item, idx) => (
          <h1 key={`dsahjs${item.id}`}>{item.genre}</h1>
        ))}
      <Swiper
        slidesPerView={5}
        spaceBetween={30}
      ...
      >
        {props.data
          .filter((movie) => movie.genre === "Fantasy")
          .map((item, i) => (
      ...
      {props.data
        ...
        .map((item, idx) => (
          <h1 key={`dsdadsaasww${item.id}`}>{item.genre}</h1>
        ))}
      <Swiper
        slidesPerView={5}
        spaceBetween={30}
      ...
      {props.data
        ...
        .map((item, idx) => (
          <h1 key={`sadsadsafwqooop${item.id}`}>{item.genre}</h1>
        ))}
      <Swiper
        slidesPerView={5}
        spaceBetween={30}
      ...
      {props.data
        .filter((movie) => movie.id === 13)
        .map((item, idx) => (
          <h1 key={`gewwqawaasfr${item.id}`}>{item.genre}</h1>
        ))}
      <Swiper
        slidesPerView={5}
        spaceBetween={30}
      ...
      >
        {props.data
          .filter((movie) => movie.genre === "Adventure")
          .map((item) => (
